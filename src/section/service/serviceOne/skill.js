        ...
        <div className="">
          <div className="grid grid-cols-12 md:gap-12 h-auto pb-16 ">
            <div className="col-span-12 md:col-span-6 text-left text-white mb-16  mt-16 lg:mt-40">
              <h1 className="font-bold text-2xl lg:text-6xl pb-12">
                Here are some of our great skills
              </h1>
              <p className="text-1xl">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras id
                arcu luctus, pellentesque lorem ac, pharetra sapien. Donec
                elementum, tortor vel viverra ultrices, lacus orci venenatis
                tortor, vel rhoncus ipsum felis a diam.
              </p>
            </div>
