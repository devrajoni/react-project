  ...
  return (
    <>
      <section className="header-section relative w-full bg-slate-900">
        ...
        <div className="text-left absolute py-60 text-white text-left px-20 md:px-40">
          ...
          <p className="w-60 md:w-96 text-1xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras id arcu luctus, pellentesque lorem ac, pharetra sapien.</p>
        </div>
      </section>
      {search ? (
