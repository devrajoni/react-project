...
export default function Similar() {
    ...
    return(
        ...
        <section className="service-section mt-16 md:mt-24 md:px-20 px-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 h-auto mb-12 drop-shadow-md text-white">
                <div className='transform transition-border origin-center  hover:border-b-4 border-[#66FCF1] duration-500 overflow-hidden' >
                    <img src={Image1}  alt='similar' className='hover:scale-125'/>
                </div>
                <div>
                    <img src={Image2}  alt='similar'/>
                </div>
                <div>
                    <img src={Image3}  alt='similar'/>
                </div>
            </div>
        </section>
        </>
